...
const Button2: FC<PropsWithChildren<Props>> = ({ children, className, color = 'blue', disabled, ...btnProps }) => {
    ...
    const bgColor = color === 'blue' ? `${disabled ? 'bg-blue-500/95' : 'bg-blue-500 hover:bg-blue-600 active:bg-blue-700'}` : `${disabled ? 'bg-green-500/95' : 'bg-green-500 hover:bg-green-600 active:bg-green-700'}`;
